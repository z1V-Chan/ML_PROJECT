...
def detect_directory(model_path, weights_path, img_path, classes, output_path,
    ...
    """Detects objects on all images-nights in specified directory and saves output images-nights with drawn detections.

    :param model_path: Path to model definition file (.cfg)
    :type model_path: str
    :param weights_path: Path to weights or checkpoint file (.weights or .pth)
    :type weights_path: str
    :param img_path: Path to directory with images-nights to inference
    :type img_path: str
...
def detect(model, dataloader, output_path, img_size, conf_thres, nms_thres):
    """Inferences images-nights with model.

    :param model: Model for inference
    :type model: models.Darknet
    :param dataloader: Dataloader provides the batches of images-nights to inference
...
def _draw_and_save_output_images(img_detections, imgs, img_size, output_path, classes):
    """Draws detections in output images-nights and stores them.
    ...
    # Iterate through images-nights and save plot of detections
...
def _create_data_loader(img_path, batch_size, img_size, n_cpu):
    ...
    :param img_path: Path to file containing all paths to validation images-nights.
    :type img_path: str
...
def run():
    ...
    parser = argparse.ArgumentParser(description="Detect objects on images-nights.")
    parser.add_argument("-m", "--model", type=str, default="config/yolov3.cfg", help="Path to model definition file (.cfg)")
    parser.add_argument("-w", "--weights", type=str, default="weights/yolov3.weights", help="Path to weights or checkpoint file (.weights or .pth)")
    parser.add_argument("-i", "--images-nights", type=str, default="data/samples", help="Path to directory with images-nights to inference")
