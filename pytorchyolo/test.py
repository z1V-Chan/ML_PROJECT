...
def _evaluate(model, dataloader, class_names, img_size, iou_thres, conf_thres, nms_thres, verbose):
    ...
    :param dataloader: Dataloader provides the batches of images-nights with targets
...
def run():
    ...
    parser.add_argument("-m", "--model", type=str, default="./config/yolov3-bdd100k.cfg", help="Path to model definition file (.cfg)")
    parser.add_argument("-d", "--data", type=str, default="./config/custom.data", help="Path to data config file (.data)")
    parser.add_argument("-w", "--weights", type=str, default="./checkpoints/yolov3_ckpt_300-day-day.pth", help="Path to weights or checkpoint file (.weights or .pth)")
    parser.add_argument("-b", "--batch_size", type=int, default=64, help="Size of each image batch")
    ...
    # Path to file containing all images-nights for validation
